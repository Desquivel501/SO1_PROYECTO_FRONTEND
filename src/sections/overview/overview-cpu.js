...
export const OverviewCpu = (props) => {
  ...
  const [state, setState] = useState({'state':0, 'titulo':"Votos por partido",'url':"http://localhost:5000/votos-partido"})
      ...
      >
        ...
        >
          <ButtonGroup variant="contained" aria-label="outlined primary button group" >
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Partido",'url':"http://localhost:5000/votos-partido"})}>Por Partido</Button>
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Municipio",'url':"http://localhost:5000/votos-muni"})}>Por Municipio</Button>
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Departamento",'url':"http://localhost:5000/votos-partido"})}>Por Departamento</Button>
          </ButtonGroup>
        </Box>
      </Grid>
