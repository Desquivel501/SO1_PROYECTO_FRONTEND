...
export const OverviewCpu = (props) => {
  ...
  const [state, setState] = useState({'state':0, 'titulo':"Votos por partido",'url':"https://35.226.8.72:3000/votos-partido"})
      ...
      >
        ...
        >
          <ButtonGroup variant="contained" aria-label="outlined primary button group" >
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Partido",'url':"https://35.226.8.72:3000/votos-partido"})}>Por Partido</Button>
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Municipio",'url':"https://35.226.8.72:3000/votos-muni"})}>Por Municipio</Button>
            <Button onClick={() => setState({'state':0, 'titulo':"Votos por Departamento",'url':"https://35.226.8.72:3000/votos-partido"})}>Por Departamento</Button>
          </ButtonGroup>
        </Box>
      </Grid>
